package com.common.arms.di.component;
...
import com.common.arms.di.module.AppModule;
import com.common.arms.di.module.ClientModule;
import com.common.arms.di.module.GlobalConfigModule;
import com.common.arms.http.imageloader.BaseImageLoaderStrategy;
import com.common.arms.http.imageloader.ImageLoader;
...
/**
 * ================================================
 * 可通过 {@link ArmsUtil#obtainAppComponentFromContext(Context)} 拿到此接口的实现类
